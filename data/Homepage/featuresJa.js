...
const features = [
  {
    ...
    subtitle: `ソーシャスは、機械学習を利用して、社会貢献への想いとキャリアゴールを両立できる機会をマッチングさせます。私たちは、社会貢献を真に充実したものにします。`,
    link:"AIマッチングについて詳しく見る",
  ...
  },
  {
    ...
    slide: "2/4",
    title: "安全に仕事と報酬を得る",
    subtitle: `ブロックチェーン技術を活用し、安全な取引と業界最安手数料を実現. プラットフォームは非常にシンプルに設計されており、通常経験するような面倒な手続きなしで、求人に応募し、採用され、報酬を得ることができます`,
    link:"社会によいブロックチェーンについて詳しく見る",
  ...
  },
  {
    ...
    subtitle: `SDGプロジェクトに貢献するたびに、あなたのインパクトスコアは伸びていきます。次々と貢献することで、自分のインパクトが蓄積され、目的志向のプロフェッショナルとして評価されるようになります。`,
    link:"インパクトスコアについて詳しく見る",
  ...
  },
  {
    ...
    slide: "4/4",
    title: "トークンを獲得する",
    subtitle: `あなたがインパクト団体のために働いたり、ボランティアをするたびに、ソーシャス上で様々商品・サービスと交換したり寄付に使えるソーシャルグッドな暗号資産であるTHANKトークンが報酬として与えられます。`,
    link:"THANKについて詳しく見る",

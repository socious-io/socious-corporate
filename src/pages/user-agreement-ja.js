    ...
    <>
      ...
      <div id="content">
          ...
          <div className="section">
              ...
              <span>（４）●ヶ月以上本サービスの利用がない場合</span><br/>
              <span>（５）当社からの問い合わせその他の回答を求める連絡に対して●日間以上応答がない場合</span><br/>
          ...
          <div className="section">
              ...
              <ol>
                  ...
                  <li>
                      <span>当社は、本サービスに関して登録ユーザーが被った損害につき、過去●月間に登録ユーザーが当社に支払った対価の金額を超えて賠償する責任を負わないものとし、また、付随的損害、間接損害、特別損害、将来の損害及び逸失利益にかかる損害については、賠償する責任を負わないものとします。</span>
                  </li>
                  <li>
